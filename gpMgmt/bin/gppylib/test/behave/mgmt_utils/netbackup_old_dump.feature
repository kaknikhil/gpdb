...
Feature: NetBackup Integration with GPDB
    ...
    @nbusmoke
    @nbupartI
    Scenario: 1 - gpdbrestore with non-supported options
    ...
    @foo2
    @nbupartI
    Scenario: 2 - Full Backup and Restore
        Given the test is initialized
...
2 -
    @nbusmoke
    @nbupartI
    Scenario: 3 - Full Backup and Restore with --netbackup-block-size option
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 4 - Full Backup and Restore with --netbackup-keyword option
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 5 - Full Backup and Restore with --netbackup-block-size and --netbackup-keyword options
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 6 - Full Backup and Restore with keyword exceeding max limit of 100 characters
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 7 - Full Backup and Restore with -u option
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 8 - Full Backup with option -t and Restore
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 9 - Full Backup with option -T and Restore
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 10 - Full Backup with option -s and Restore
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartI
    Scenario: 11 - Full Backup with option -t and Restore after TRUNCATE on filtered tables
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 12 - Full Backup with option --exclude-table-file and Restore
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 13 - Full Backup with option --table-file and Restore
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 14 - Schema only restore of full backup
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 15 - Full Backup and Restore without compression
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 16 - Verify the gpcrondump -o option is not broken due to NetBackup changes
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 17 - Verify the gpcrondump -c option is not broken due to NetBackup changes
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 18 - Verify the gpcrondump -g option is not broken due to NetBackup changes
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 19 - Verify the gpcrondump -h option works with full backup
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 20 - gpdbrestore -u option with full backup timestamp
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 21 - gpcrondump -x with multiple databases
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartI
    Scenario: 22 - gpdbrestore with --table-file option
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 23 - Multiple full backup and restore from first full backup
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 24 - gpdbrestore with -T option
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 25 - gpdbrestore list_backup option with full timestamp
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        When the user runs "gpcrondump -a -x bkdb --netbackup-block-size 2048" using netbackup
    ...
    @nbupartI
    Scenario: 26 - gpdbrestore list_backup option with incremental backup
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 27 - User specified timestamp key for dump
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_index_table" in "bkdb" with data
    ...
    ######## Scenario: 28 - Full Backup with --list-netbackup-files and --prefix options
    ######## Add scenario for invalid netbackup params

    ######## Restore with NetBackup using invalid timestamp - error message can be improved
    @nbupartI
    Scenario: 29 - User specified invalid timestamp key for restore
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_index_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 30 - Full Backup and Restore with --prefix option
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartI
    Scenario: 31 - Full Backup and Restore with -u and --prefix option
        Given the test is initialized
        And the netbackup params have been parsed
        And the prefix "foo" is stored
        And there is a "heap" table "public.heap_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 32 - Restore database without prefix for a dump with prefix
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_index_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 33 - Full Backup and Restore of external and ao table
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 34 - Full Backup and Restore filtering tables with post data objects
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 35 - Full Backup and Restore dropped database filtering tables with post data objects
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "heap" table "public.heap_index_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 36 - Full backup and restore for table names with multibyte (chinese) characters
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartI
    Scenario: 37 - Full Backup with option -T and Restore with exactly 1000 partitions
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 38 - Single table restore with shared sequence across multiple tables
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartI
    Scenario: 39 - Full backup and restore using gpcrondump with pg_class lock
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartI
    Scenario: 40 - Restore -T for full dump should restore metadata/postdata objects for tablenames with English and multibyte (chinese) characters
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_index_table" with index "ao_index" compression "None" in "bkdb" with data
        And there is a "co" table "public.co_index_table" with index "co_index" compression "None" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 41 - Full Backup and Restore with the master dump file missing
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" partition table "public.ao_part_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 42 - Full Backup and Restore with the master dump file missing without compression
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" partition table "public.ao_part_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 43 - Uppercase Database Name Full Backup and Restore using timestamp
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbusmoke
    @nbupartI
    Scenario: 44 - Verify that metadata files get backed up to NetBackup server
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbusmoke
    @nbupartI
    Scenario: 45 - Basic Incremental Backup and Restore with NBU
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 46 - Increments File Check With Complicated Scenario
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbusmoke
    @nbupartI
    Scenario: 47 - Incremental File Check With Different Directory
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" table "public.ao_table" in "bkdb" with data
    ...
    @nbupartI
    Scenario: 48 - Simple Plan File Test
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "heap" partition table "public.heap_part_table" in "bkdb" with data
...
##----------------------------------------------------------------------------------------------------
    ...
    Scenario: 1 - gpdbrestore with non-supported options
	    Given the new database is started
        And the netbackup params have been parsed
        When the user runs "gpdbrestore -e -s bkdb -a"
...
##----------------------------------------------------------------------------------------------------
    ...
    @nbupartII
    Scenario: 49 - Multiple Incremental backup and restore
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbusmoke
    @nbupartII
    Scenario: 50 - Non compressed incremental backup
        Given the test is initialized
        And the netbackup params have been parsed
        And there is schema "testschema" exists in "bkdb"
        And there is a "heap" table "testschema.heap_table" in "bkdb" with data
    ...
    @nbupartII
    Scenario: 51 - Verify the gpcrondump -h option works with full and incremental backups
        Given the test is initialized
        And the netbackup params have been parsed
        And there is schema "testschema" exists in "bkdb"
        And there is a "ao" table "testschema.ao_table" in "bkdb" with data
    ...
    @nbupartII
    Scenario: 52 - gpdbrestore -u option with incremental backup timestamp
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "ao" table "public.ao_table" in "bkdb" with data
        And there is a "co" table "public.co_table" in "bkdb" with data
    ...
    @nbupartII
    Scenario: 53 - Incremental backup with -T option
        Given the test is initialized
        And the netbackup params have been parsed
        And there is a "heap" table "public.heap_table" in "bkdb" with data
        And there is a "ao" partition table "public.ao_part_table" in "bkdb" with data
    ...
    @nbupartII
    Scenario: 54 - Dirty File Scale Test
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartII
    Scenario: 55 - Dirty File Scale Test for partitions
        Given the test is initialized
        And the netbackup params have been parsed
		And there are "240" "heap" tables "public.heap_table" with data in "bkdb"
    ...
    @nbupartII
    Scenario: 56 - Incremental table filter gpdbrestore
        Given the test is initialized
        And the netbackup params have been parsed
    ...
    @nbupartII
    Scenario: 57 - Incremental table filter gpdbrestore with noplan option
        Given the test is initialized
        And the netbackup params have been parsed
        And there are "2" "heap" tables "public.heap_table" with data in "bkdb"
        And there is a "ao" partition table "public.ao_part_table" in "bkdb" with data
    ...
    @nbupartII
    Scenario: 58 - Multiple full and incrementals with and without prefix
        Given the test is initialized
        And the netbackup params have been parsed
        And the prefix "foo" is stored
        And there is a list to store the incremental backup timestamps
    ...
    @nbupartII
    Scenario: 59 - Incremental Backup and Restore with --prefix and -u options
        Given the test is initialized
        And the netbackup params have been parsed
        And the prefix "foo" is stored
        And there is a list to store the incremental backup timestamps
    ...
    @nbupartII
    Scenario: 60 - Incremental Backup with table filter on Full Backup should update the tracker files
        Given the test is initialized
        And the netbackup params have been parsed
        And the prefix "foo" is stored
        And there is a list to store the incremental backup timestamps
    ...
    @nbupartII
    Scenario: 61 - Incremental Backup and Restore of specified post data objects
        Given the test is initialized
        And the netbackup params have been parsed
        And there is schema "testschema" exists in "bkdb"
        And there is a list to store the incremental backup timestamps
    ...
    @nbupartII
    Scenario: 62 - Restore -T for incremental dump should restore metadata/postdata objects for tablenames with English and multibyte (chinese) characters
        Given the test is initialized
        And the netbackup params have been parsed
